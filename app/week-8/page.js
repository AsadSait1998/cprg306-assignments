  ...
  return (
    <main className="min-h-screen px-6 py-12 md:px-10">
      <div className="mx-auto max-w-4xl rounded-[2rem] border border-white/10 bg-[var(--panel)] p-8 shadow-[0_18px_60px_rgba(0,0,0,0.24)] backdrop-blur md:p-10">
        <p className="mb-3 text-sm uppercase tracking-[0.24em] text-cyan-200">Week 8</p>
        <h1 className="text-4xl font-bold text-white md:text-5xl">Authenticated Shopping List</h1>
        <p className="mt-4 max-w-2xl text-lg leading-8 text-slate-300">
          This week introduces GitHub authentication before users can access the shopping list
          experience.
        </p>
        ...
        {!user && (
          <div className="mt-8 rounded-[1.5rem] border border-cyan-300/15 bg-slate-950/55 p-6">
            ...
            <p className="mt-3 max-w-xl text-slate-300">
              Once you sign in with GitHub, you can open the protected Week 8 shopping list page.
            </p>
